    ...
    return(
        <View style={{flex:1}}>
            <View style={{flex:0.5,background:'#fff'}}>
                ...
                >
                <View style={{justifyContent:'center',alignItems:'center',height:480,background:'#fff',borderWidth:5,borderColor:'#ddd',position:"absolute",width:300}}>
                    <ScrollView>
                        {
